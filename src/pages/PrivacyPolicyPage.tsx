...
const PrivacyPolicyPage: React.FC = () => {
    return <>
        <h1 style={{ textAlign: 'center'}}><b>PRIVACY POLICY</b></h1>
        <p>Last updated: July 23, 2022</p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DoOld.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to DoOld, accessible from <RouterLink to='/' >https://do-old.web.app</RouterLink></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: <Link href='mailto:me@tinaeldevresse.eu'>me@tinaeldevresse.eu</Link></li>
        </ul>
    </>;
};
